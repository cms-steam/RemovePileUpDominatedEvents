// -*- C++ -*-
//
// Package:    NtuplerPUEvents/NtuplerPUEvents
// Class:      NtuplerPUEvents
// 
/**\class NtuplerPUEvents NtuplerPUEvents.cc NtuplerPUEvents/NtuplerPUEvents/plugins/NtuplerPUEvents.cc
...
class NtuplerPUEvents : public edm::EDAnalyzer {
   public:
      explicit NtuplerPUEvents(const edm::ParameterSet&);
      ~NtuplerPUEvents();
...
NtuplerPUEvents::NtuplerPUEvents(const edm::ParameterSet& iConfig):
...
NtuplerPUEvents::~NtuplerPUEvents()
{ 
   // do anything here that needs to be done at desctruction time
   // (e.g. close files, deallocate resources etc.)
}

void NtuplerPUEvents::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    using namespace std;
    using namespace edm;
...
void 
NtuplerPUEvents::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
NtuplerPUEvents::endJob() 
{
}


void NtuplerPUEvents::respondToOpenInputFile(edm::FileBlock const & file){
...
/*
void 
NtuplerPUEvents::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
NtuplerPUEvents::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
NtuplerPUEvents::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
NtuplerPUEvents::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
NtuplerPUEvents::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(NtuplerPUEvents);
